...
function submitname () {
	...
	message001.innerHTML = "Choose your team.";
}
function skip () {
	document.getElementById("skip").style.visibility = "hidden";
	document.getElementById("skip").style.display = "none";
...
var opp = ["Alba", "Andreyko", "Atchity", "Bancroft", "Barbarian", "Cushing"];
...
player002.innerHTML = team[0];
player003.innerHTML = team[1];
player004.innerHTML = team[2];
player005.innerHTML = team[3];
player006.innerHTML = opp[0];
player007.innerHTML = opp[1];
player008.innerHTML = opp[2];
player009.innerHTML = opp[3];
player010.innerHTML = opp[4];
