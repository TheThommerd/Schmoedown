...
else if (document.getElementById("passwordsaverQuarter").value == "BOONTA EVE"){
...
message004.innerHTML = "<select id=select><option value=Cabrera>Andres Cabrera</option><option value=Napzok>Ken Napzok</option></select></br></br><button id=choose onclick=choosecomp()>Choose Opponent</button>";
...
message004.innerHTML = "<button class=buttons001 onclick=repeat001()>Play again</button>" + "</br></br></br>" + "You have unlocked the next round. Use the password 'Bantha' to enter.";
