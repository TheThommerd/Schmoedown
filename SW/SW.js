...
function load(){
intromusic.play();
	if (document.getElementById("wins_SW").value.length < 1){document.getElementById("wins_SW").value = 0;}
	if (document.getElementById("losses_SW").value.length < 1){document.getElementById("losses_SW").value = 0;}
...
function newLoc() {window.location.assign("https://thethommerd.github.io/Schmoedown/SW%20Tournament.html");}
 	var a = 0;
        a++;
        var r = 0;
        r++;
...
if (a == 3){startTyping(question001[1].ques, 40, "message001");}
if (a == 4){startTyping(question001[2].ques, 40, "message001");}
if (a == 5){startTyping(question001[3].ques, 40, "message001");}
if (a == 6){startTyping(question001[4].ques, 40, "message001");}
if (a == 7){startTyping(question001[14].ques, 40, "message001");}
if (a == 8){startTyping(question001[15].ques, 40, "message001");}
...
if (a == 26){startTyping(question001[16].ques, 40, "message001");}
if (a == 27){startTyping(question001[17].ques, 40, "message001");}
if (a == 28){startTyping(question001[18].ques, 40, "message001");}
if (a == 29){startTyping(question001[19].ques, 40, "message001");}
...
if (mc != 0){
	    ...
	    message006.innerHTML = "";
            score001.innerHTML = b+=1;
	    stealmc--;
if (mc == 1){message001.innerHTML = compcat[5].ques;
...
if (mc == 2){message001.innerHTML = compcat[6].ques;
...
if (mc == 3){message001.innerHTML = compcat[7].ques;
...
if (mc == 4){message001.innerHTML = compcat[8].ques;
...
if (mc == 5){message001.innerHTML = compcat[9].ques; message004.innerHTML = "<button class=buttons002 onclick=next005()>Next</button><br /><br /><button id=chalacc class=buttons004 onclick=ChallengeAccepted()>Win Challenge</button><button id=chalden class=buttons005 onclick=ChallengeDenied()>Lose Challenge</button>";}
}
}
        function qinc() {
		if (difficult == 1){
...
if (mc == 5){message001.innerHTML = compcat[9].ques;
	    document.getElementById("JTE").style.visibility = "hidden";
            window.clearInterval(update);
            c = "-";
...
if (chance < percentage3){
		...
		message005.innerHTML = "";
if (s - b > 0){
if (usertwo == 0){message006.innerHTML = competitorlist[0].lowercase + " hit the 2 pointer." + "</br></br>" + "Your first category is " + question001[8].cat;}
else if ((usertwo == 1) && (userthree == 0)){message006.innerHTML = competitorlist[0].lowercase + " hit the 2 pointer." + "</br></br>" + "Your next category is " + threepointer001[0].cat;}
else if ((usertwo == 1) && (userthree == 1) && (userfive == 0)){message006.innerHTML = competitorlist[0].lowercase + " hit the 2 pointer." + "</br></br>" + "Your next category is " + fivepointer001[0].cat;}
else if ((usertwo == 1) && (userthree == 1) && (userfive == 1)){message006.innerHTML = competitorlist[0].lowercase + " hit the 2 pointer.";}
}
else if (b - s >= 0){message006.innerHTML = competitorlist[0].lowercase + " hit the 2 pointer.";}
		...
		message005.innerHTML = "";
if (s - b > 0){
if (usertwo == 0){message006.innerHTML = competitorlist[0].lowercase + " missed the 2 pointer." + "</br></br>" + "Your first category is " + question001[8].cat;}
else if ((usertwo == 1) && (userthree == 0)){message006.innerHTML = competitorlist[0].lowercase + " missed the 2 pointer." + "</br></br>" + "Your next category is " + threepointer001[0].cat;}
else if ((usertwo == 1) && (userthree == 1) && (userfive == 0)){message006.innerHTML = competitorlist[0].lowercase + " missed the 2 pointer." + "</br></br>" + "Your next category is " + fivepointer001[0].cat;}
else if ((usertwo == 1) && (userthree == 1) && (userfive == 1)){message006.innerHTML = competitorlist[0].lowercase + " missed the 2 pointer.";}
}
else if (b - s >= 0){message006.innerHTML = competitorlist[0].lowercase + " missed the 2 pointer.";}
            	message004.innerHTML = "<button id=chal class=buttons006 onclick=Challenge()>Challenge</button> <br /><br /><button class=buttons002 onclick=analyser3()>Next</button><br /><br /><button id=chalacc class=buttons004 onclick=ChallengeAccepted()>Win Challenge</button><button id=chalden class=buttons005 onclick=ChallengeDenied()>Lose Challenge</button>";
		document.getElementById("chal").style.visibility = "hidden";
		}
		answeredtwo++;
...
if (chance < percentage3){
		...
		message005.innerHTML = "";
if (s - b > 0){
if (usertwo == 0){message006.innerHTML = competitorlist[0].lowercase + " hit the 3 pointer." + "</br></br>" + "Your first category is " + question001[8].cat;}
else if ((usertwo == 1) && (userthree == 0)){message006.innerHTML = competitorlist[0].lowercase + " hit the 3 pointer." + "</br></br>" + "Your next category is " + threepointer001[0].cat;}
else if ((usertwo == 1) && (userthree == 1) && (userfive == 0)){message006.innerHTML = competitorlist[0].lowercase + " hit the 3 pointer." + "</br></br>" + "Your next category is " + fivepointer001[0].cat;}
else if ((usertwo == 1) && (userthree == 1) && (userfive == 1)){message006.innerHTML = competitorlist[0].lowercase + " hit the 3 pointer.";}
}
else if (b - s >= 0){message006.innerHTML = competitorlist[0].lowercase + " hit the 3 pointer.";}
            	message004.innerHTML = "<button id=chal class=buttons006 onclick=Challenge()>Challenge</button> <br /><br /><button class=buttons002 onclick=analyser3()>Next</button><br /><br /><button id=chalacc class=buttons004 onclick=ChallengeAccepted()>Win Challenge</button><button id=chalden class=buttons005 onclick=ChallengeDenied()>Lose Challenge</button>";
		document.getElementById("chal").style.visibility = "hidden";
		}
else { 
		...
		message005.innerHTML = "";
if (s - b > 0){
if (usertwo == 0){message006.innerHTML = competitorlist[0].lowercase + " missed the 3 pointer." + "</br></br>" + "Your first category is " + question001[8].cat;}
else if ((usertwo == 1) && (userthree == 0)){message006.innerHTML = competitorlist[0].lowercase + " missed the 3 pointer." + "</br></br>" + "Your next category is " + threepointer001[0].cat;}
else if ((usertwo == 1) && (userthree == 1) && (userfive == 0)){message006.innerHTML = competitorlist[0].lowercase + " missed the 3 pointer." + "</br></br>" + "Your next category is " + fivepointer001[0].cat;}
else if ((usertwo == 1) && (userthree == 1) && (userfive == 1)){message006.innerHTML = competitorlist[0].lowercase + " missed the 3 pointer.";}
}
else if (b - s >= 0){message006.innerHTML = competitorlist[0].lowercase + " missed the 3 pointer.";}
            	message004.innerHTML = "<button id=chal class=buttons006 onclick=Challenge()>Challenge</button> <br /><br /><button class=buttons002 onclick=analyser3()>Next</button><br /><br /><button id=chalacc class=buttons004 onclick=ChallengeAccepted()>Win Challenge</button><button id=chalden class=buttons005 onclick=ChallengeDenied()>Lose Challenge</button>";
		document.getElementById("chal").style.visibility = "hidden";
		}
		answeredthree++;
...
if (s - b > 0){
if (usertwo == 0){message006.innerHTML = competitorlist[0].lowercase + " hit the 5 pointer." + "</br></br>" + "Your first category is " + question001[8].cat;}
else if ((usertwo == 1) && (userthree == 0)){message006.innerHTML = competitorlist[0].lowercase + " hit the 5 pointer." + "</br></br>" + "Your next category is " + threepointer001[0].cat;}
else if ((usertwo == 1) && (userthree == 1) && (userfive == 0)){message006.innerHTML = competitorlist[0].lowercase + " hit the 5 pointer." + "</br></br>" + "Your next category is " + fivepointer001[0].cat;}
else if ((usertwo == 1) && (userthree == 1) && (userfive == 1)){message006.innerHTML = competitorlist[0].lowercase + " hit the 5 pointer.";}
}
else if (b - s >= 0){message006.innerHTML = competitorlist[0].lowercase + " hit the 5 pointer.";}
            	message004.innerHTML = "<button id=chal class=buttons006 onclick=Challenge()>Challenge</button> <br /><br /><button class=buttons002 onclick=analyser3()>Next</button><br /><br /><button id=chalacc class=buttons004 onclick=ChallengeAccepted()>Win Challenge</button><button id=chalden class=buttons005 onclick=ChallengeDenied()>Lose Challenge</button>";
		document.getElementById("chal").style.visibility = "hidden";
		}
else { 
		...
		message005.innerHTML = "";
if (s - b > 0){
if (usertwo == 0){message006.innerHTML = competitorlist[0].lowercase + " missed the 5 pointer." + "</br></br>" + "Your first category is " + question001[8].cat;}
else if ((usertwo == 1) && (userthree == 0)){message006.innerHTML = competitorlist[0].lowercase + " missed the 5 pointer." + "</br></br>" + "Your next category is " + threepointer001[0].cat;}
else if ((usertwo == 1) && (userthree == 1) && (userfive == 0)){message006.innerHTML = competitorlist[0].lowercase + " missed the 5 pointer." + "</br></br>" + "Your next category is " + fivepointer001[0].cat;}
else if ((usertwo == 1) && (userthree == 1) && (userfive == 1)){message006.innerHTML = competitorlist[0].lowercase + " missed the 5 pointer.";}
}
else if ((b - s) == 0){
...
if (s - b > 10){loseKO();}
		...
		else if (b -s >= 0){message006.innerHTML =  competitorlist[0].lowercase + " has to answer first.";}
		...
		document.getElementById("message004").style = "initial";
	    	document.getElementById("message003").style.top = "-5px";
	    	document.getElementById("message006").style.top = "-95px";
}
}
function next004 () {
simulatecomputerround2();
