...
message004.innerHTML = "<select id=select><option value=Andreyko>Marc Andreyko</option><option value=Kalinowski>Mike Kalinowski</option><option value=Meyer>Brendan Meyer</option><option value=Reilly>Mark Reilly</option><option value=Sneider>Jeff Sneider</option></select></br></br><button id=choose onclick=choosecomp()>Choose Opponent</button>";
