...
document.getElementById("passwordsaverEight").value = "WILDBERRIES";
            	message004.innerHTML = "<button class=buttons001 onclick=repeat001()>Play again</button>" + "</br></br></br>" + "You have unlocked the next round. Use the password 'Wildberries' to enter.";
