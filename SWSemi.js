...
function load(){
if (document.getElementById("passwordsaverSemi").value != "BANTHA"){
...
else if (document.getElementById("passwordsaverSemi").value == "BANTHA"){
...
message004.innerHTML = "<select id=select><option value=Dimalanta>Andrew Dimalanta</option><option value=Kelly>Laura Kelly</option></select></br></br><button id=choose onclick=choosecomp()>Choose Opponent</button>";
...
document.getElementById("passwordsaverChamp").value = "PORKINS";
message004.innerHTML = "<button class=buttons001 onclick=repeat001()>Play again</button>" + "</br></br></br>" + "You have unlocked the next round. Use the password 'Porkins' to enter.";
