function load(){
intromusic.play();
if (document.getElementById("2022passwordsaverR2").value != "LION'S DEN"){
...
else if (document.getElementById("2022passwordsaverR2").value == "LION'S DEN"){
...
document.getElementById("2022passwordsaverR2").value = document.getElementById("password").value.toUpperCase();
if (ww == "LION'S DEN")
{
message004.innerHTML = "<input id=q2 type=text maxlength=15 placeholder=Name /><br /><br /><input id=q3 placeholder=@Twitter type=text maxlength=15 /><br /><br /><br /><button id=submit3  class=buttons001 onclick=submitname()>Submit </button><br /><br /><button id=skip class=buttons001 onclick=skip()>Skip</button>";
message006.innerHTML = "";
...
message004.innerHTML = "<select id=select><option value=Lomis>Brother Lomis</option><option value=Gubbins>Peggy Gubbins</option><option value=Mancuso>Vinnie Mancuso</option><option value=White>James White</option></select></br></br><button id=choose onclick=choosecomp()>Choose Opponent</button>";
