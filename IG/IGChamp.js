...
var roundoneadd = [jurassicpark[0], swashbuckling[0], graphicnovels[0], dystopiantime[0], superman[0], batman[0], xmen[0], spiderman[0], scoressoundtracks[0], whosaidit[0], alienpredator[0]];
roundoneadd = shuffle(roundoneadd);
var roundthree = [dcmovies[1], marvelmovies[1], lotr[1], harrypotter[1], startrek[1], starwars[1], mixedbag[1], heroesvillains[1], jurassicpark[1], swashbuckling[1], graphicnovels[1], dystopiantime[1], superman[1], batman[1], xmen[1], spiderman[1], scoressoundtracks[1], whosaidit[1], alienpredator[1], planetoftheapes[0], tmnt[0], animated[0], transformers[0]];
...
function begin001() {
	...
	document.getElementById("time001").style.top = "-75px";
            message001.innerHTML = question001[0].ques;if (difficult == 1){message001.innerHTML = " ";startTyping(question001[0].ques, 40, "message001");}
...
if (mc == 5){message001.innerHTML = compcat[9].ques; message004.innerHTML = "<button class=buttons002 onclick=bettinground()>Next</button><br /><br /><button id=chalacc class=buttons004 onclick=ChallengeAccepted()>Win Challenge</button><button id=chalden class=buttons005 onclick=ChallengeDenied()>Lose Challenge</button>";}
}
}
        function qinc() {
		if (difficult == 1){
...
function winKO(){
		...
		document.getElementById("championships_IG").stepUp(1);
...
function speedquestions2() {	
	...
	if (difficult == 1){hidemessage = setTimeout(function() { message()}, 2000);}
	    ...
	    document.getElementById("message004").style.display = "initial";
	    document.getElementById("message005").style.display = "initial";
	    document.getElementById("message002").style.top = "-105px";
		document.getElementById("time001").style.fontSize = "200%";
		document.getElementById("time001").style.fontWeight = "bold";
                message003.innerHTML = "";
                message005.innerHTML = "";
...
function mcquestion3(){
		...
		document.getElementById("time001").style.fontSize = "200%";
		document.getElementById("time001").style.fontWeight = "bold";
		document.getElementById("time001").style.top = "-55px";
                update = setInterval("timer001()", 1000);
                c = 20;
                time001.innerHTML = 20;
                message001.innerHTML = compcat[7].ques;
