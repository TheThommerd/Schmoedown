function load(){
intromusic.play();
if (document.getElementById("2022passwordsaverQuarter").value != "YODI"){
...
else if (document.getElementById("2022passwordsaverQuarter").value == "YODI"){
...
document.getElementById("2022passwordsaverQuarter").value = document.getElementById("password").value.toUpperCase();
if (ww == "YODI")
{
message004.innerHTML = "<input id=q2 type=text maxlength=15 placeholder=Name /><br /><br /><input id=q3 placeholder=@Twitter type=text maxlength=15 /><br /><br /><br /><button id=submit3  class=buttons001 onclick=submitname()>Submit </button><br /><br /><button id=skip class=buttons001 onclick=skip()>Skip</button>";
message006.innerHTML = "";
...
message004.innerHTML = "<select id=select><option value='Del Rio'>David Del Rio</option><option value=Frabetti>Paige Frabetti</option><option value=Smith>Kevin Smith</option><option value=Tom>Tom</option></select></br></br><button id=choose onclick=choosecomp()>Choose Opponent</button>";
