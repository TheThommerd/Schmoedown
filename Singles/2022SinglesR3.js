function load(){
intromusic.play();
if (document.getElementById("2022passwordsaverR3").value != "COLLISION"){
...
else if (document.getElementById("2022passwordsaverR3").value == "COLLISION"){
...
document.getElementById("2022passwordsaverR3").value = document.getElementById("password").value.toUpperCase();
if (ww == "COLLISION")
{
message004.innerHTML = "<input id=q2 type=text maxlength=15 placeholder=Name /><br /><br /><input id=q3 placeholder=@Twitter type=text maxlength=15 /><br /><br /><br /><button id=submit3  class=buttons001 onclick=submitname()>Submit </button><br /><br /><button id=skip class=buttons001 onclick=skip()>Skip</button>";
message006.innerHTML = "";
...
message004.innerHTML = "<select id=select><option value=Duralde>Alonso Duralde</option><option value=Harley>Nick Harley</option><option value=Kempe>Jen Kempe</option><option value=Nemiroff>Perri Nemiroff</option></select></br></br><button id=choose onclick=choosecomp()>Choose Opponent</button>";
