...
rounds++;
	    ...
	    document.getElementById("message002").style.top = "-450px";
...
if (question001[0].ques.length > 125){
	...
	document.getElementById("player003").style.top = "-6px";
	document.getElementById("player004").style.top = "-26px";
	document.getElementById("player005").style.top = "-48px";
	document.getElementById("score001").style.top = "-64px";
	document.getElementById("score002").style.top = "-101px";
	document.getElementById("score003").style.top = "-141px";
	document.getElementById("score004").style.top = "-181px";
	document.getElementById("score005").style.top = "-221px";
	...
	document.getElementById("round002").style.top = "-306px";
	    document.getElementById("time001").style.top = "-409px";
}
...
if (question001[vraag].ques.length > 125){
	...
	document.getElementById("score001").style.top = "-63px";
	document.getElementById("score002").style.top = "-100px";
