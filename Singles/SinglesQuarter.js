...
function load(){
if (document.getElementById("passwordsaverQuarter").value != "BESPIN"){
...
else if (document.getElementById("passwordsaverQuarter").value == "BESPIN"){
...
message004.innerHTML = "<select id=select><option value=Andreyko>Marc Andreyko</option><option value=Kalinowski>Mike Kalinowski</option><option value=Meyer>Brendan Meyer</option><option value=Sneider>Jeff Sneider</option><option value=Reilly>Mark Reilly</option></select></br></br><button id=choose onclick=choosecomp()>Choose Opponent</button>";
...
document.getElementById("passwordsaverSemi").value = "SHIREWOLVES";
            	message004.innerHTML = "<button class=buttons001 onclick=repeat001()>Play again</button>" + "</br></br></br>" + "You have unlocked the next round. Use the password 'Shirewolves' to enter.";
