...
function load(){
if (document.getElementById("passwordsaverQuarter").value != "PENNYWORTH"){
...
else if (document.getElementById("passwordsaverQuarter").value == "PENNYWORTH"){
message004.innerHTML = "<input id=q2 type=text maxlength=15 placeholder=Name /><br /><br /><input id=q3 placeholder=@Twitter type=text maxlength=15 /><br /><br /><br /><button id=submit3  class=buttons001 onclick=submitname()>Submit </button><br /><br /><button id=skip class=buttons001 onclick=skip()>Skip</button>";
...
function choosecomp() {
	...
	message005.innerHTML = "You selected " +competitorlist[0].lowercase + "." + "</br></br>" + "His/her strengths are " + competitorlist[0].strength1 + ", " + competitorlist[0].strength2 + " and " + competitorlist[0].strength3 + ".";
...
document.getElementById("passwordsaverQuarter").value = document.getElementById("password").value.toUpperCase();
if (ww == "PENNYWORTH")
{
message004.innerHTML = "<input id=q2 type=text maxlength=15 placeholder=Name /><br /><br /><input id=q3 placeholder=@Twitter type=text maxlength=15 /><br /><br /><br /><button id=submit3  class=buttons001 onclick=submitname()>Submit </button><br /><br /><button id=skip class=buttons001 onclick=skip()>Skip</button>";
message006.innerHTML = "";
...
message004.innerHTML = "<select id=select><option value=Damon>Alex Damon</option><option value=Ellison>Chance Ellison</option><option value=Inman>Jason Inman</option></select></br></br><button id=choose onclick=choosecomp()>Choose Opponent</button></div>";
...
var roundoneadd = [jurassicpark[0], swashbuckling[0], graphicnovels[0], dystopiantime[0], superman[0], batman[0], xmen[0], spiderman[0]];
roundoneadd = shuffle(roundoneadd);

var roundthree = [dcmovies[1], marvelmovies[1], lotr[1], harrypotter[1], startrek[1], starwars[1], mixedbag[1], heroesvillains[1], jurassicpark[1], swashbuckling[1], graphicnovels[1], dystopiantime[1], superman[1], batman[1], xmen[1], spiderman[1], scoressoundtracks[0], whosaidit[0], alienpredator[0], planetoftheapes[0], tmnt[0], animated[0], transformers[0]];
...
function winKO(){
 ...
 message006.innerHTML = "<b>" + "Stats" + "</b>" + "</br></br>" + "<table class=table2><style>.table2 { border-spacing: 0; width: 50%; margin-left: 120px;} .th2, .td2, .tr2 {padding: 4px; font-size: 90%;}</style><tr class=tr2><th class=th2></th><th class=th2>" + document.getElementById("naam").value + "</th><th class=th2>" + competitorlist[0].id+ "</th></tr><tr class=tr2><td class=td2><b>Questions answered</b></td><td class=td2>" + quescount + "</td><td class=td2>" + quescountopp + "</td></tr class=tr2><tr class=tr2><td class=td2><b>PPE</b></td><td class=td2>" + ppe.toFixed(2) + "%" + "</td><td class=td2>" + ppeopp.toFixed(2) + "%" + "</td></tr><tr class=tr2><td class=td2><b>Accuracy</b></td><td class=td2>" + accuracy.toFixed(2) + "%" + "</td><td class=td2>" + accuracyopp.toFixed(2) + "%" + "</td></tr></table>";
		...
		document.getElementById("save").click();
document.getElementById("passwordsaverSemi").value = "GREAT SCOTT";
message004.innerHTML = "<button class=buttons001 onclick=repeat001()>Play again</button>" + "</br></br></br>" + "You have unlocked the next round. Use the password 'Great Scott' to enter.";
...
score002.innerHTML = s+=1;
	    ...
	    message005.innerHTML = "";
            message004.innerHTML = "<button id=chal class=buttons006 onclick=Challenge()>Challenge</button> <br /><br /><button class=buttons002 onclick=next001()>Next</button><br /><br /><button id=chalacc class=buttons004 onclick=ChallengeAccepted()>Win Challenge</button><button id=chalden class=buttons005 onclick=ChallengeDenied()>Lose Challenge> 4</button>";
	percentage = competitorlist[0].percentage;
            }
