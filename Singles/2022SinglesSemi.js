function load(){
intromusic.play();
if (document.getElementById("2022passwordsaverSemi").value != "SPECTACULAR"){
...
else if (document.getElementById("2022passwordsaverSemi").value == "SPECTACULAR"){
...
document.getElementById("2022passwordsaverSemi").value = document.getElementById("password").value.toUpperCase();
if (ww == "SPECTACULAR")
{
message004.innerHTML = "<input id=q2 type=text maxlength=15 placeholder=Name /><br /><br /><input id=q3 placeholder=@Twitter type=text maxlength=15 /><br /><br /><br /><button id=submit3  class=buttons001 onclick=submitname()>Submit </button><br /><br /><button id=skip class=buttons001 onclick=skip()>Skip</button>";
message006.innerHTML = "";
...
message004.innerHTML = "<select id=select><option value=Bancroft>Jacoby Bancroft</option><option value=Bateman>Ben Bateman</option><option value=Horowitz>Josh Horowitz</option><option value=Kan>Jeffrey Kan</option></select></br></br><button id=choose onclick=choosecomp()>Choose Opponent</button>";
