...
function load(){
if (document.getElementById("passwordsaverR3").value != "YADDLE"){
...
else if (document.getElementById("passwordsaverR3").value == "YADDLE"){
...
document.getElementById("passwordsaverEight").value = "BIB FORTUNA";
message004.innerHTML = "<button class=buttons001 onclick=repeat001()>Play again</button>" + "</br></br></br>" + "You have unlocked the next round. Use the password 'Bib Fortuna' to enter.";
