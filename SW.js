...
if (j == 3) {
  ...
  if (h == 1) {
	    c = 16;
             j--;
	    document.getElementById("frame001").style.backgroundImage = "url('uploads2/fantasymts/SW/2JTEChal.png')";
	    }
  else if (h < 1) {
	    c = 16;
             j--;
	    document.getElementById("frame001").style.backgroundImage = "url('uploads2/fantasymts/SW/2JTE.png')";
	    }
}
else if (j == 1) {
  if (h == 1) {
	    c = 16;
             j--;
	    document.getElementById("frame001").style.backgroundImage = "url('uploads2/fantasymts/SW/1JTEChal.png')";
	    }
  else if (h < 1) {
	    c = 16;
             j--;
	   document.getElementById("frame001").style.backgroundImage = "url('uploads2/fantasymts/SW/1JTE.png')";
	    }
}
else if (j == 0) {
 if (h == 1) {
	    c = 16;
             j--;
	    document.getElementById("frame001").style.backgroundImage = "url('uploads2/fantasymts/SW/Chal.png')";
	     }
 else if (h < 1) {
	    c = 16;
             j--;
	    document.getElementById("frame001").style.backgroundImage = "url('uploads2/fantasymts/SW/Nothing.png')";
	    }
}
else if (j < 0) {
...
function ChallengeDenied(){
	    document.getElementById("message004").style.top = "-190px";
if (j == 2) {
	    document.getElementById("frame001").style.backgroundImage = "url('uploads2/fantasymts/SW/3JTE.png')";
	     h--;
	     h--;
	    document.getElementById("chalacc").style.visibility = "hidden";
	    document.getElementById("chalden").style.visibility = "hidden";
