...
if (j == 3) {
  ...
  if (h == 1) {
	    c = 16;
            j--;
	    document.getElementById("frame001").style.backgroundImage = "url('Singles/Singles___2JTEChal.png')";
	    }
  else if (h < 1) {
	    c = 16;
             j--;
	    document.getElementById("frame001").style.backgroundImage = "url('Singles/Singles___2JTE.png')";
	    }
}
else if (j == 1) {
  if (h == 1) {
	    c = 16;
             j--;
	    document.getElementById("frame001").style.backgroundImage = "url('Singles/Singles___1JTEChal.png')";
	    }
  else if (h < 1) {
	    c = 16;
             j--;
	   document.getElementById("frame001").style.backgroundImage = "url('Singles/Singles___1JTE.png')";
	    }
}
else if (j == 0) {
 if (h == 1) {
	    c = 16;
             j--;
	    document.getElementById("frame001").style.backgroundImage = "url('Singles/Singles___NoJTEChal.png')";
	     }
 else if (h < 1) {
	    c = 16;
             j--;
	    document.getElementById("frame001").style.backgroundImage = "url('Singles/Singles___NoJTE.png')";
	    }
}
else if (j < 0) {
...
function ChallengeDenied(){
	    document.getElementById("message004").style.top = "-230px";
if (j == 2) {
	    document.getElementById("frame001").style.backgroundImage = "url('Singles/Singles___NoChal.png')";
	     h--;
	     h--;
	    document.getElementById("chalacc").style.visibility = "hidden";
	    document.getElementById("chalden").style.visibility = "hidden";
