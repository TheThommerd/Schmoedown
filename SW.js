...
message004.innerHTML = "<select id=select><option value=Cabrera>Andres Cabrera</option><option value=Damon>Alex Damon</option><option value=damon>Mollie Damon</option><option value=Dimalanta>Andrew Dimalanta</option><option value=Kelly>Laura Kelly</option><option value=Napzok>Ken Napzok</option><option value=Scrimshaw>Joseph Scrimshaw</option><option value=Sullivan>Sean Sullivan</option><option value=Witt>Adam Witt</option><option value=Witwer>Sam Witwer</option></select></br></br><button id=choose onclick=choosecomp()>Choose Opponent</button>";
...
if (j == 3) {
  ...
  if (h == 1) {
	    c = 16;
             j--;
	    document.getElementById("frame001").style.backgroundImage = "url('https://files.jcink.net/uploads2/fantasymts/SW/2JTEChal.png')";
	    }
  else if (h < 1) {
	    c = 16;
             j--;
	    document.getElementById("frame001").style.backgroundImage = "url('https://files.jcink.net/uploads2/fantasymts/SW/2JTE.png')";
	    }
}
else if (j == 1) {
  if (h == 1) {
	    c = 16;
             j--;
	    document.getElementById("frame001").style.backgroundImage = "url('https://files.jcink.net/uploads2/fantasymts/SW/1JTEChal.png')";
	    }
  else if (h < 1) {
	    c = 16;
             j--;
	   document.getElementById("frame001").style.backgroundImage = "url('https://files.jcink.net/uploads2/fantasymts/SW/1JTE.png')";
	    }
}
else if (j == 0) {
 if (h == 1) {
	    c = 16;
             j--;
	    document.getElementById("frame001").style.backgroundImage = "url('https://files.jcink.net/uploads2/fantasymts/SW/Chal.png')";
	     }
 else if (h < 1) {
	    c = 16;
             j--;
	    document.getElementById("frame001").style.backgroundImage = "url('https://files.jcink.net/uploads2/fantasymts/SW/Nothing.png')";
	    }
}
else if (j < 0) {
...
function ChallengeDenied(){
	    document.getElementById("message004").style.top = "-190px";
if (j == 2) {
	    document.getElementById("frame001").style.backgroundImage = "url('https://files.jcink.net/uploads2/fantasymts/SW/3JTE.png')";
	     h--;
	     h--;
	    document.getElementById("chalacc").style.visibility = "hidden";
	    document.getElementById("chalden").style.visibility = "hidden";
