...
message004.innerHTML = "<select id=select><option value=Barbarian>The Barbarian</option><option value=Moses>Amaru Moses</option><option value=Navarro>Hector Navarro</option></select></br></br><button id=choose onclick=choosecomp()>Choose Opponent</button></div>";
