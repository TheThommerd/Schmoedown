function load(){
intromusic.play();
if (document.getElementById("2022passwordsaverEight").value != "KORRUPTION"){
...
else if (document.getElementById("2022passwordsaverEight").value == "KORRUPTION"){
...
document.getElementById("2022passwordsaverEight").value = document.getElementById("password").value.toUpperCase();
if (ww == "KORRUPTION")
{
message004.innerHTML = "<input id=q2 type=text maxlength=15 placeholder=Name /><br /><br /><input id=q3 placeholder=@Twitter type=text maxlength=15 /><br /><br /><br /><button id=submit3  class=buttons001 onclick=submitname()>Submit </button><br /><br /><button id=skip class=buttons001 onclick=skip()>Skip</button>";
message006.innerHTML = "";
...
message004.innerHTML = "<select id=select><option value=Alvarez>Frankie Alvarez</option><option value=Blunden>Jacob Blunden</option><option value=Lieberman>Ty Lieberman</option><option value=Raddus>Rick Raddus</option></select></br></br><button id=choose onclick=choosecomp()>Choose Opponent</button>";
